...
public class ClientProofreadersAccumulator extends ProcessFunction<ClientProofreader, ClientProofreadersList> {
    ...
    @Override
    public void processElement(ClientProofreader clientProofreader, Context context, Collector<ClientProofreadersList> collector) throws Exception {
        List<ClientProofreader> prfList = Lists.newArrayList(clientProofreader);
